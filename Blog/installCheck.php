	...
	<!doctype html>
		<html>
			...
			<body>
				...
				<h3>This is the example of 404 not found view in Smooth.</h3>
				<br> <br> <br>
			      <div class="masthead">
			        <ul class="nav nav-pills pull-right">
			          <li class="active"><a href="#">Dependency Test</a></li>
			        </ul>
			        <h3 class="muted">Smooth version 1.0.3</h3>
			      </div>
			      ...
			      <hr>
		            ...
		            <tbody>
						...
						<tr>
							...
							<td>
								<?php echo memory_get_usage(). ' bytes'; ?>
							</td>
						</tr>
						<tr>
							<td>
							...
							<td>
								<?php echo memory_get_peak_usage(). ' bytes'; ?>
							</td>
						</tr>
